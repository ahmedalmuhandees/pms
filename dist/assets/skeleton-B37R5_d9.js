import{C as e,Jt as t,Xt as n,Zt as r,_n as i,ir as a,mn as o,rn as s,un as c,vt as l,x as u}from"./client-ByQROz3u.js";var d={class:`page-header`},f={class:`page-header__text`},p={key:0,class:`page-header__eyebrow`},m={class:`page-header__title`},h={key:1,class:`page-header__subtitle`},g={key:0,class:`page-header__actions`},_=s({__name:`PageHeader`,props:{title:{},subtitle:{}},setup(e){return(s,c)=>(o(),r(`header`,d,[t(`div`,f,[e.subtitle?(o(),r(`p`,p,`لوحة الإدارة`)):n(``,!0),t(`h2`,m,a(e.title),1),e.subtitle?(o(),r(`p`,h,a(e.subtitle),1)):n(``,!0)]),s.$slots.actions?(o(),r(`div`,g,[i(s.$slots,`actions`)])):n(``,!0)]))}}),v=e.extend({name:`skeleton`,style:`
    .p-skeleton {
        display: block;
        overflow: hidden;
