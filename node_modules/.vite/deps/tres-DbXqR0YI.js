import { $n as toRefs$1, An as customRef, Dt as mergeProps, Ft as onMounted, G as createBlock, Gn as readonly, Jn as shallowReadonly, Jt as renderSlot, K as createCommentVNode, Kn as ref, M as Fragment, Nn as getCurrentScope, Ot as nextTick, Rn as isRef, U as computed, Ut as provide, Vn as onScopeDispose, Vt as openBlock, Wn as reactive, X as createRenderer, Yn as shallowRef, _n as watchEffect, ar as normalizeClass, dn as useSlots, er as toValue, gn as watch, ht as hasInjectionContext, jt as onBeforeUnmount, nr as unref, nt as defineComponent, pt as h, q as createElementBlock, sr as normalizeStyle, ut as getCurrentInstance, xn as withCtx, xt as inject, zt as onUnmounted } from "./vue.runtime.esm-bundler-DJa8Dn_V.js";
import { $t as DirectionalLightHelper, Bo as Sphere, Bs as Vector2, Dr as Line, Hi as Object3D, J as BufferAttribute, Ko as SpotLightHelper, O as ArrowHelper, Oo as Scene, Or as Line3, Un as HemisphereLightHelper, Vo as SphereGeometry, Vs as Vector3, Y as BufferGeometry, Zr as Material, ai as Mesh, c as three_module_exports, ca as PointLightHelper, ct as Color, do as Raycaster, ei as MathUtils, ia as Plane, kr as LineBasicMaterial, ms as Timer, o as WebGLRenderer, oi as MeshBasicMaterial, ra as PerspectiveCamera, ri as Matrix4, st as Clock, uo as Ray, va as Quaternion, vr as Layers, vs as Triangle, xn as Float32BufferAttribute } from "./three.module-omPc_b5b.js";
import { t as setupDevToolsPlugin } from "./dist-BjgRk5Y9.js";
...
//#endregion
//#region node_modules/@pmndrs/pointer-events/dist/html-event.js
var HtmlEvent = class {
	nativeEvent;
	NONE = 0;
	CAPTURING_PHASE = 1;
...
//#endregion
//#region node_modules/@pmndrs/pointer-events/dist/event.js
...
//#endregion
//#region node_modules/@pmndrs/pointer-events/dist/intersections/intersector.js
...
//#endregion
//#region node_modules/@pmndrs/pointer-events/dist/intersections/utils.js
...
//#endregion
//#region node_modules/@pmndrs/pointer-events/dist/pointer.js
...
var Pointer = class {
	...
	*/
	...
	setEnabled(enabled, nativeEvent, commit = true) {
		...
		if (!enabled && this.pointerCapture != null) this.clearPointerCapture();
	...
	*/
	...
	cancel(nativeEvent) {
		...
		this.clearPointerCapture();
		this.onFirstMove.length = 0;
		if (!this.enabled || !this.wasMoved || this.intersection == null) return;
	...
	exit(nativeEvent) {
		if (this.buttonsDown.size > 0 || this.pointerCapture != null) this.cancel(nativeEvent);
		if (this.wasMoved) {
	...
	clearPointerCapture() {
		if (this.pointerCapture == null) return;
...
//#endregion
//#region node_modules/@pmndrs/pointer-events/dist/utils.js
...
//#endregion
//#region node_modules/@pmndrs/pointer-events/dist/intersections/ray.js
...
new Matrix4();
//#endregion
//#region node_modules/@pmndrs/pointer-events/dist/pointer/index.js
var pointerIdCounter = 23412;
function generateUniquePointerId() {
	return pointerIdCounter++;
}
//#endregion
//#region node_modules/@pmndrs/pointer-events/dist/forward.js
...
//#endregion
//#region node_modules/@tresjs/core/dist/tres.js
/**
* name: @tresjs/core
* version: v5.8.3
* (c) 2026
...
var revision = Number.parseInt("185".replace("dev", ""));
/**
...
var getRoot = (canvas) => _roots.get(canvas);
var setRoot = (canvas, root) => {
	_roots.set(canvas, root);
};
var deleteRoot = (canvas) => _roots.delete(canvas);
...
function setupTresDevtools(ctx) {
	...
	const fps = /* @__PURE__ */ useFps({ every: updateInterval });
...
var Context_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const createInternalComponent = (context$1, hmrTick) => defineComponent({ setup() {
		...
		const mountCustomRenderer = (context$1) => {
			const canvas = props.canvas;
			if (getRoot(canvas)) return;
			const hmrTick = ref(0);
			const internalComponent = createInternalComponent(context$1, hmrTick);
			const renderer$1 = createRenderer(nodeOps({
				context: context$1,
				options: props.customRendererOptions
			}));
			renderer$1.render(h(internalComponent), scene.value);
			setRoot(canvas, {
				renderer: renderer$1,
				internalComponent,
				hmrTick,
		...
		const unmountCanvas = () => {
			...
			root.renderer.render(null, scene.value);
...
//#endregion
export { useDraggable as $, isTresObject as A, template_compiler_options_default as B, isObject3D as C, isScene as D, isProd as E, logWarning as F, useRendererManager as G, useGraph as H, normalizeColor as I, useTresContextProvider as J, useTres as K, normalizeVectorFlexibleParam as L, isVectorLike as M, logError as N, isTresCamera as O, logMessage as P, onKeyStroke as Q, registerTresDevtools as R, isMesh as S, isPerspectiveCamera as T, useLoader as U, useCameraManager as V, useLoop as W, vLightHelper as X, vDistanceTo as Y, vLog as Z, isFog as _, buildGraph as a, useScroll as at, isLight as b, createTimer as c, tryOnScopeDispose as ct, isBufferGeometry as d, whenever as dt, useElementSize as et, isCamera as f, isCopyable as g, isColorRepresentation as h, TresRendererError as i, useResizeObserver as it, isTresPrimitive as j, isTresInstance as k, disposeObject3D as l, useDebounceFn as lt, isColor as m, DevtoolsMessenger as n, useMagicKeys as nt, catalogue as o, useWindowScroll as ot, isClassInstance as p, useTresContext as q, TresCanvas_default as r, useMouse as rt, component_default as s, useWindowSize as st, Context_default as t, useEventListener as tt, extend as u, watchThrottled as ut, isGroup as v, isOrthographicCamera as w, isMaterial as x, isLayers as y, src_default as z };
