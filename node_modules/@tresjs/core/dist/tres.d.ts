...
import { EventHookOff, UseAsyncStateOptions, UseAsyncStateReturn } from "@vueuse/core";
...
declare function useRendererManager({
  ...
  canBeInvalidated: vue14.ComputedRef<boolean>;
  mode: "always" | "on-demand" | "manual" | undefined;
  replaceRenderFunction: (fn: RenderFunction) => void;
  isInitialized: vue14.Ref<boolean, boolean>;
  error: vue14.Ref<TresRendererError | null, TresRendererError | null>;
};
...
declare const __VLS_export$2: <T extends TresObjectMap>(__VLS_props: NonNullable<Awaited<typeof __VLS_setup>>["props"], __VLS_ctx?: __VLS_PrettifyLocal<Pick<NonNullable<Awaited<typeof __VLS_setup>>, "attrs" | "emit" | "slots">>, __VLS_exposed?: NonNullable<Awaited<typeof __VLS_setup>>["expose"], __VLS_setup?: Promise<{
  props: vue14.PublicProps & __VLS_PrettifyLocal<{
    /**
...
declare const useGraph: (object: MaybeRef<TresObject | undefined>) => vue14.ComputedRef<TresObjectMap | undefined>;
//#endregion
...
declare const useLoop: () => {
  stop: () => void;
  start: () => void;
  isActive: Readonly<vue14.ShallowRef<boolean>>;
...
declare const __VLS_base$1: vue14.DefineComponent<__VLS_Props, {
  context: vue14.ShallowRef<TresContext, TresContext>;
  dispose: () => void;
...
}, string, vue14.PublicProps, Readonly<__VLS_Props> & Readonly<{
...
declare const __VLS_base: vue14.DefineComponent<ContextProps, TresCanvasInstance, {}, {}, {}, vue14.ComponentOptionsMixin, vue14.ComponentOptionsMixin, {
  click: (event: TresPointerEvent) => any;
  contextmenu: (event: TresPointerEvent) => any;
  pointermove: (event: TresPointerEvent) => any;
  pointerenter: (event: TresPointerEvent) => any;
  ...
  beforeLoop: (context: TresContextWithClock) => any;
  loop: (context: TresContextWithClock) => any;
}, string, vue14.PublicProps, Readonly<ContextProps> & Readonly<{
  onClick?: ((event: TresPointerEvent) => any) | undefined;
  onContextmenu?: ((event: TresPointerEvent) => any) | undefined;
  onPointermove?: ((event: TresPointerEvent) => any) | undefined;
  onPointerenter?: ((event: TresPointerEvent) => any) | undefined;
...
//#endregion
//#region src/utils/createTimer.d.ts
interface TresTimer {
  getDelta: () => number;
  getElapsed: () => number;
  update: () => void;
 ...
 *
 */
declare function createTimer(): TresTimer;
//#endregion
 ...
 *   value.geometry // OK
 */
declare const isMesh: (value: unknown) => value is Mesh<BufferGeometry<THREE.NormalBufferAttributes, THREE.BufferGeometryEventMap>, Material<THREE.MaterialEventMap> | Material<THREE.MaterialEventMap>[], THREE.Object3DEventMap>;
/**
 ...
 * ```
 */
declare const isMaterial: (value: unknown) => value is Material<THREE.MaterialEventMap>;
/**
